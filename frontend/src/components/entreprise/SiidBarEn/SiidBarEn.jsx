      ...
      <div className="sidebar">
        ...
        <div className="sidebar-menu">
          ...
          <div className="menu-section">
            ...
            <Link to="/entreprise" className="menu-item">
          ...
          <div className="menu-section">
            ...
            <div className={`submenu ${openSections.reclamations ? 'open' : ''}`}>
              ...
              <Link to="/entreprise/reclamations/listsreclamation" className="submenu-item">
                <i className="submenu-icon fas fa-search"></i>
                Réclamations 
              </Link>
              <Link to="/entreprise/reclamations/listsrefuser" className="submenu-item">
          ...
          <div className="menu-section">
            ...
            <div className={`submenu ${openSections.techniciens ? 'open' : ''}`}>
              ...
              <Link to="/entreprise/techniciens/liststechnicien" className="submenu-item">
                <i className="submenu-icon fas fa-tags"></i>
                Liste des Techniciens
              </Link>
              <Link to="/entreprise/techniciens/cherchertechnicien" className="submenu-item">
                <i className="submenu-icon fas fa-tags"></i>
          ...
          <div className="menu-section">
            ...
            <div className={`submenu ${openSections.Blacklist ? 'open' : ''}`}>
              ...
              <Link to="/entreprise/blacklist" className="submenu-item">
                <i className="submenu-icon fas fa-plus-circle"></i>
                Blacklist Directory
              </Link>
            </div>
