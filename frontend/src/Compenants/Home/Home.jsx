        ...
        <div className="container">
          ...
          <div className="row text-center">
            <div className="col-md-4 mb-5 mb-md-0">
              <div className="testimonial-card">
                <div className="d-flex justify-content-center mb-4">
                  <img src="images/IMG1.jpg" className="rounded-circle shadow-1-strong" width="150" height="150" alt="Maria Smantha" />
                </div>
            ...
            <div className="col-md-4 mb-5 mb-md-0">
              <div className="testimonial-card">
                <div className="d-flex justify-content-center mb-4">
                  <img src="images/IMG3.jpg" className="rounded-circle shadow-1-strong" width="150" height="150" alt="Lisa Cudrow" />
                </div>
            ...
            <div className="col-md-4 mb-0">
              <div className="testimonial-card">
                <div className="d-flex justify-content-center mb-4">
                  <img src="/images/IMG4.jpg" className="rounded-circle shadow-1-strong" width="150" height="150" alt="John Smith" />
                </div>
