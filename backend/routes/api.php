...
// routes/api.php
Route::middleware('auth:sanctum')->get('/api/user', function ($request) {
    return response()->json([
        'role' => $request->user()->role, // Make sure your User model has this
    ...
    Route::middleware(['auth:sanctum', 'entreprise'])->prefix('entreprise')->group(function() {
        Route::get('/entreprise/dashboard', [EntrepriseDashboardController::class, 'index']);
